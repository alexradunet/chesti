...
1. Open **Page → Start here · your workspace is made of primitives** and choose **Read saved**. Follow its links to the project brief, writing guide, view guide, and safe-experiment guide. Page's List and Gallery layouts browse the same content.
